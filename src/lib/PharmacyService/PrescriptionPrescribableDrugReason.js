...
exports.createPrescriptionPrescribableDrugReason = async (
  ...
  try {
    ...
    const prescriptionPrescribableDrugReasonCreated = await request(
      requestOptions
    );
...
exports.getPrescriptionPrescribableDrugReasonBreakdown = async (doctorId) => {
  try {
    ...
    const prescriptionPrescribableDrugReasonBreakdown = await request(
      requestOptions
    );
