...
module.exports = (fastify, options, next) => {
  fastify.get('/prescription-reason', {schema: prescriptionReasonSchema.getPrescriptionReasonWithFilter}, prescriptionReasonService.getPrescriptionReasonsWithFilter);
  ...
  fastify.delete('/prescription-reason/:id', {schema: prescriptionReasonSchema.deletePrescriptionReason}, prescriptionReasonService.deletePrescriptionReason);
	...
	fastify.get('/prescription-reason/:patientId/by-prescribable', {schema: prescriptionReasonSchema.getPrescriptionReasonByPrescribable}, prescriptionReasonService.getPrescriptionReasonByPrescribable);
