...
exports.createPrescriptionReasons = async (req, reply) => {
  try {
    const prescriptionReason = await prescriptionReasonRequests.createPrescriptionReason(
...
exports.patchPrescriptionReason = async (req, reply) => {
  try {
    const prescriptionReason = await prescriptionReasonRequests.patchPrescriptionReason(
      req.params.id,
      req.body.prescriptionReason
    );
    return { prescriptionReason };
...
exports.getPrescriptionReasonByPrescribable = async (req, reply) => {
  try {
    const prescriptionReasonsByPrescribable = await prescriptionReasonRequests.getPrescriptionReasonByPrescribable(
...
exports.getPrescriptionReasonCount = async (req, reply) => {
  try {
    const prescriptionReasonCount = await prescriptionReasonRequests.getPrescriptionReasounCount(
      req.params.patientId
    );
...
exports.getPrescriptionReasonsWithFilter = async (req, reply) => {
  try {
    const prescriptionReasons = await prescriptionReasonRequests.getPrescriptionReasonWithFilter(
      req.query
    );
