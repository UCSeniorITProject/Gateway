...
exports.getPrescriptionPrescribableDrugCountForLastYear = async (req, reply) => {
	try {
		const prescriptionPrescribableDrugCount = await presriptionPrescribableDrug.getPrescriptionPrescribableDrugCountForLastYear(req.params.patientId);
...
exports.getCountOfPrescribablesPerDoctor = async (req, reply) => {
	try {
		const prescribablesPerDoctor = await presriptionPrescribableDrug.getCountOfPrescribablesPerDoctor(req.params.patientId);
