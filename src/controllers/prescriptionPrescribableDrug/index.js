...
module.exports = (fastify, options, next) => {
  fastify.post('/', {schema: prescriptionPrescribableDrugSchema.createPrescriptionPrescribableDrug}, prescriptionPrescribableDrugService.createPrescriptionPrescribableDrug);
