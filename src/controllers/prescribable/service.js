...
exports.createPrescribable = async (req, reply) => {
  try {
    const prescribable = await prescribableRequest.createPrescribable(
...
exports.patchPrescribable = async (req, reply) => {
  try {
    const prescribable = await prescribableRequest.patchPrescribable(
      req.params.id,
      req.body.prescribable
    );
...
exports.getPrescribableWithFilter = async (req, reply) => {
  try {
    const prescribables = await prescribableRequest.getPrescribableWithFilter(
      req.query
    );
...
exports.getPrescribableByMonth = async (req, reply) => {
  try {
    const prescribableByMonth = await prescribableRequest.getPrescribablesPerMonth(
...
exports.getPrescribableBreakDownByDoctor = async (req, reply) => {
  try {
    const prescribableBreakDown = await prescribableRequest.getNumberOfPrescribableByMonthForDoctor(
      req.params.doctorId
    );
...
exports.getPrescribableBreakdownByPatientForDoctor = async (req, reply) => {
  try {
    const prescribableByPatientForMonth = await prescribableRequest.getNumberOfPrescribablesByPatientForDoctor(
      req.params.doctorId
    );
...
exports.getNumPrescribablesPerMonthForDoctor = async (req, reply) => {
  try {
    const prescribableByPatientForMonth = await prescribableRequest.getNumPrescribablesPerMonthForDoctor(
      req.params.doctorId
    );
    return { data: prescribableByPatientForMonth };
  } catch (err) {
